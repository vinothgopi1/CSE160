...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        for (let i = 0; i < other1.elements.length; i++) {
            d = d + (other1.elements[i] * other2.elements[i]);
        }
    ...
    static cross(other1, other2) {
        ...
        var new_x = (other1.elements[1] * other2.elements[2]) - (other1.elements[2] * other2.elements[1]);
        var new_y = (other1.elements[2] * other2.elements[0]) - (other1.elements[0] * other2.elements[2]);
        var new_z = (other1.elements[0] * other2.elements[1]) - (other1.elements[1] * other2.elements[0]);

        let v3 = new Vector3([new_x, new_y, new_z]); // Modify this line to calculate cross product between other1 and other2.
    ...
    magnitude() {
        ...
        // Don't delete the return statement.
        for (let i = 0; i < this.elements.length; i++){
            m = m + (this.elements[i] * this.elements[i]);
        }
